...
@EnableZuulProxy
public class GatewayScoreApp {

    private static final Logger log = LoggerFactory.getLogger(GatewayScoreApp.class);

    private final Environment env;

    public GatewayScoreApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes gateway_score.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GatewayScoreApp.class);
